...
let word0 = stringToEmoji(word: "blah")
let word1 = stringToEmoji(word: "happy")
print(word0)
print(word1)
/*:
...
print(stringToEmojis(word: "bleh"))
/*:
...
*/
func orEmojis(word: String) -> Character {
...
print(orEmojis(word: "happy"))
print(orEmojis(word: "laughing"))
print(orEmojis(word: "cool"))
print(orEmojis(word: "bleh"))
print(orEmojis(word: "good"))
print(orEmojis(word: "okay"))
print(orEmojis(word: "awesome"))
print(orEmojis(word: "lit"))
print(orEmojis(word: "fun"))
