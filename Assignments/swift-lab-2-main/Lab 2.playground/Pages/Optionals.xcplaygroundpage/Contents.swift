...
if let definitelyAString = username  {
    print("username contains a valid username, and it is \(definitelyAString)")
} else {
    print("username does not contain a valid string")
}

let login: String? = nil
let user = login ?? "joey121"
